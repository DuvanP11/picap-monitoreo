"""
Wrapper de ejecución automática del generador "Estado de cuenta SURTITODO".

Uso: doble-click en este archivo (o `python ejecutar_estado_cuenta.py` desde cualquier shell).
"""
...
MES = "2026-04"
OUTPUT = None  # None = auto: "Estado de cuenta SURTITODO Abril 2026.xlsx"
...
GENERADOR  = SCRIPT_DIR / "generar_estado_cuenta.py"
...
def generar(mes, output=None):
    ...
    if output:
        ...
        año, mes_n = mes.split("-")
        out_name = f"Estado de cuenta SURTITODO {meses_es[mes_n]} {año}.xlsx"
...
def main():
    print("═══════════════════════════════════════════════════════════════════════════")
    print(" GENERADOR AUTOMATICO — ESTADO DE CUENTA SURTITODO")
    print("═══════════════════════════════════════════════════════════════════════════")
    print(f"  Mes:    {MES}")
